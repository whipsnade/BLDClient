	...
	public void addSuggestData(final List<Suggest> list,final ViewFlowImageAdapter image_adapter,final CircleFlowIndicator indic) {
		...
		this.post(new Runnable() {
			...
			public void run() {
				...
				HttpResourcesTask task = new HttpResourcesTask(getContext(), HttpType.Img,
...
//										//TampDraw.
										View convertView = image_adapter.mInflater.inflate(R.layout.image_item, null);
//										
									...
									setAdapter(image_adapter);
									setFlowIndicator(indic);
								}
	...
	OnClickListener childOnClickListen = new OnClickListener() {
	    ...
	    //    bundle.putString("id", ((suggest) arg0.getTag()).getId() );
	       Context con=getContext();
			//con.startActivity(new Intent(getContext(),SubjectDetailActivity.class).putExtras(bundle));
			}
